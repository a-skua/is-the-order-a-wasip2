    ...
    pub mod component {
        ...
        pub mod calc {
            ...
            pub mod calc {
                ...
                macro_rules! __export_component_calc_calc_0_1_0_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

          #[export_name = "component:calc/calc@0.1.0#add"]
          unsafe extern "C" fn export_add(arg0: i32,arg1: i32,) -> i32 {
            $($path_to_types)*::_export_add_cabi::<$ty>(arg0, arg1)
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_calc_calc_0_1_0_cabi;
            }
        }
    }
}
...
macro_rules! __export_root_impl {
  ...
  $($path_to_types_root)*::exports::component::calc::calc::__export_component_calc_calc_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::calc::calc);
  )
}
#[doc(inline)]
...
B\x02\x01@\x02\x01xz\x01yz\0z\x04\0\x03add\x01\0\x04\x01\x19component:calc/calc@\
0.1.0\x05\0\x04\x01\x19component:calc/root@0.1.0\x04\0\x0b\x0a\x01\0\x04root\x03\
